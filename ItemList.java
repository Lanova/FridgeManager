...
public class ItemList {
	...
	/**
	 * Returns an ItemList of perishable items with the name of the list being the
	 * parameter passed in.
	 *
	...
	/**
	 * Returns an ItemList of expired items with a name and the date to check the
	 * item to.
	 *
	...
	/**
	 * Chech if the items from mustHave in a fridge, if so return the list of these
	 * items.
	 *
	 * 
	...
	public boolean equals(ItemList itemList) {
		return (itemList.getName().equals(name)) && (itemList.getNumberOfItems() == numberOfItems)
